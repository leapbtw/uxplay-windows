<# Builds and validates the recursive PE dependency closure of the ARM64 bundle.
   Reads imports with objdump and automatically copies missing CLANGARM64 DLLs. #>
[CmdletBinding()]
param(
